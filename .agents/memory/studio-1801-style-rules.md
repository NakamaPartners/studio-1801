...
- Big display headlines the user calls "bold" use Inter Tight semibold (a Helvetica-style grotesque the user picked from a reference); everything else stays Instrument Sans. Currently applied to the hero h1 and the strategy-section headline.
